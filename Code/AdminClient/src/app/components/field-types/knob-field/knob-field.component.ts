...
import { KnobMetadata } from 'src/app/interfaces/field-metadata';
import { KnobModule } from 'primeng/knob';

@Component({
  selector: 'app-knob-field',
  standalone: true,
  imports: [CommonModule, FormsModule, KnobModule],
  templateUrl: './knob-field.component.html',
})
export class KnobFieldComponent extends BaseFieldComponent<number, KnobMetadata> implements OnInit {
